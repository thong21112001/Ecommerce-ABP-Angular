//Using bên EcommerceABP.Domain các folder
using EcommerceABP.ProductAttributes;
using EcommerceABP.Inventories;
using EcommerceABP.InventoryTickets;
using EcommerceABP.Manufacturers;
using EcommerceABP.Orders;
using EcommerceABP.ProductCategories;
using EcommerceABP.Products;
using EcommerceABP.Promotions;
//End using bên EcommerceABP.Domain các folder
    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //End Config EcommerceABP


        /* Configure your own tables/entities inside here */
        //->Đã làm trong project EcommerceABP.EntityFrameworkCore -> folder Configurations
    }
}
