...
public class EcommerceABPHttpApiHostModule : AbpModule
{
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<EcommerceABPApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}EcommerceABP.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<EcommerceABPApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}EcommerceABP.Application"));
            });
        }
    }
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("EcommerceABP");
        if (!hostingEnvironment.IsDevelopment())
        {
